...
# Download these files from https://gist.github.com/ksimonyan/3785162f95cd2d5fee77
...
net.blobs['data'].reshape(1, 3, 224, 224)  # batch size, # 3-channel (BGR) images, # image size is 224x224
###########################################################
...
if __name__ == "__main__":   
     for k, class_dir in enumerate(os.listdir(os.path.join(dataset_root, images_dir))):
